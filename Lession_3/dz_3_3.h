...
на экране графические элементы (линии, многоугольники, текст и т.д.). Каждый объект
имеет возможность быть отрисован на экране и подвержен изменению формы. Если с
графическими объектами всё просто, то текст всегда обрабатывается иначе.
Разработайте адаптер для класса TextView, чтобы иметь возможность работать со
всеми объектами графического редактора одинаковыми методами.
*/

#ifndef DZ_3_3_H_INCLUDED
#define DZ_3_3_H_INCLUDED
